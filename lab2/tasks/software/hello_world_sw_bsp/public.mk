...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../DE10_LITE_Golden_Top.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x21090
SOPC_SYSID_FLAG += --sidp=0x21090
ELF_PATCH_FLAG  += --sidp 0x21090

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1738809869
SOPC_SYSID_FLAG += --timestamp=1738809869
ELF_PATCH_FLAG  += --timestamp 1738809869
